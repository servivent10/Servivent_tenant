...
export const FilterBar = ({ filters, onFilterChange, onClear, onToggleAdvanced, isAdvancedOpen, statusOptions, rightActions = null }) => {
    ...
    return html`
        <div class="p-4 bg-white rounded-t-lg shadow-sm border-b-0 border">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div class="lg:col-span-1 grid grid-cols-2 gap-4 items-end">
                    <div>
